<template lang='pug'>
section.position-relative.overflow-hidden.bg-white.min-vh-100.d-flex.flex-column.justify-content-center.align-items-center#about-us
  .container.d-flex.flex-column.justify-content-center.my-5.flex-grow-1
