      ...
      .glide__track(data-glide-el="track")
        ul.glide__slides
          li.glide__slide.d-flex.justify-content-center(v-for="slideItem in slide_items")
            img.lazyload.img-fluid.rounded.flex-fill(:data-src="slideItem.image_item.filename" height="700" :title="slideItem.image_item.filename.title" style="max-height: 700px; object-fit: contain;")
